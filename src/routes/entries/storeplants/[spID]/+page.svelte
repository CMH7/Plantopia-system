<script>
  ...
  $: crumbs = [
    ...
    },
    {
      ...
      link: `/entries/storeplants/${data.plant.id}`
    }
  ]
  ...
  const saveChanges = async () => {
    ...
    let form = document.getElementById('formSaveSP')
    // @ts-ignore
...
<form id='formSaveSP' class="hidden" method="post" action="?/savePlant" use:enhance>
