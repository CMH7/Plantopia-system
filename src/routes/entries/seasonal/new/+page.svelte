<script>
  ...
  const saveChanges = async () => {
    ...
    let form = document.getElementById('formAddPlant')
    // @ts-ignore
...
<form id='formAddPlant' class="hidden" method="post" action="?/addPlant" use:enhance>
